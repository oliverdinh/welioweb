...
namespace WaxWelio.Web.HelperClasses
{
    using System;
    ...
    public static class Helper
    {
        ...
        public static int InsertConfigurationValuesInSharepoint(List<ConfigurationDetails> configDetails)
        {
            try
            {
                foreach (ConfigurationDetails config in configDetails)
                {
        ...
        public static IList<ConfigurationDetails> GetConfigurationDetailsFromSharepoint()
        {
        ...
        public static IList<Questionnaire> GetQuestionaire(string category)
        {
            try
            {
        ...
        /// <param name="meetingId">The meeting identifier.</param>
        /// <returns></returns>
        public static List<QuestionnaireDto> GetQuestionnaireInformation(string meetingId)
        {
