...
namespace WaxWelio.Web.Controllers
{
    ...
    public class MeetingController : ApiController
    {
        public async Task<IHttpActionResult> Get() //string customId, string displayName, string emrId, string startTime, string patient
        {
            ...
            bool isMobileDevice = false;//HttpContext.Current.Request.Browser.IsMobileDevice;
            ...
            else
            {
                ...
                resp.Content = new StringContent(GlobalConstant.BaseUrl + "/Appointment/Conference?" + encodedParameters, System.Text.Encoding.UTF8, "text/plain");
                url = ConfigValues.HealthCarePortal + "/Appointment/Conference?" + encodedParameters;
                uri = new Uri(url);
            }
